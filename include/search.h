...
int32_t quiescent_min(struct board_state *, int32_t alpha, int32_t beta, int depth);
int32_t quiescent_max(struct board_state *, int32_t alpha, int32_t beta, int depth);
